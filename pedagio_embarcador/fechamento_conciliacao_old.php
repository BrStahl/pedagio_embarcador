...
<fieldset>
  ...
  <table width="1250" border="0" align="center">
  	<tr>
          ...
          <table width="350" border="1" align="left">
            <tr>
              <td width="15%"><div align="left"><strong><font size="-1">Per&iacute;odo:</font></strong></font><FONT color="#FF0000" size="-1">*</FONT></div></td>
             <!-- <td width="90%">&nbsp;
		...
		if($ano >= 2000 && $ano <= 3000){
			...
			echo "<table>
				...
				$query  = "SELECT
								...
								ISNULL(DIVERSOS.SALDO_BRADESCO,0) DIVERSOS_BRADESCO,
							...
							FROM
								...
								(SELECT 
								 ...
								 FROM
								(SELECT DISTINCT 
									CONVERT(VARCHAR(10), FXCX.DATA, 103) DATA_FORMATADA_FXCX,
									CONVERT(VARCHAR(10), FXCX.DATA, 120) DATA_FXCX,
									...
									LEFT JOIN CARGOSOL..LANCAMENTO_OPERACAO LO WITH (NOLOCK) ON
										...
										AND LO.SUB_GRUPO_CONTABIL_ID IN (2081)
										AND LO.TAB_STATUS_PAGTO_ID IN (1,135,525,535)	
										AND ((LO.TAB_FORMA_PAGTO_ID = 17) OR (LO.TAB_FORMA_PAGTO_ID IS NULL))
										
									WHERE DATEADD(DD,DATEDIFF(DD,0,FXCX.DATA),0) BETWEEN '$nova_dt_inicial' AND '$nova_dt_final'
							...
							LEFT JOIN 
								...
								(SELECT
									...
									SUM(DIVERSOS_TABLE.DEBITO_BRADESCO) SALDO_BRADESCO,
								...
								(SELECT DISTINCT
									...
									JOIN CARGOSOL..LANCAMENTO_OPERACAO LO WITH (NOLOCK) ON
										...
										AND REPLACE(LO.VALOR_LANC_RS,'.',',') = CASE WHEN LEN(VALOR_TRANSACAO) = 1
																				...
																				END
										AND (LAYOUT_ARQUIVO.DATA_TRANSACAO BETWEEN CONVERT(VARCHAR,ISNULL(LO.DATA_EFET, FXCX.DATA),112) AND CONVERT(VARCHAR,DATEADD(HH,3,ISNULL(LO.DATA_EFET, LO.DATA_VENCTO)),112)) 
					...
					echo "<table width='1250' border='1' align='center'>
							<tr>
							  <td colspan='1' bgcolor='#999999'><div align='center'><strong>Data</strong></div></td>
							  <td width='1' rowspan='1000'><div align='center'></div></td>
							  <td colspan='1' width=12% bgcolor='#999999'><div align='center'><strong>Dia Semana</strong></div></td>
							  <td width='1' rowspan='1000'><div align='center'></div></td>
							  <td colspan='3' bgcolor='#999999'><div align='center'><strong>Adiantamento</strong></div></td>
							  <td width='1' rowspan='1000'><div align='center'></div></td>
							  <td colspan='3' width=25% bgcolor='#999999'><div align='center'><strong>Ped&aacute;gio</strong></div></td>
							  <td width='1' rowspan='1000'><div align='center'></div></td>
							  <td colspan='3' bgcolor='#999999'><div align='center'><strong>Saldo</strong></div></td>
							  <td width='1' rowspan='1000'><div align='center'></div></td>
							  <td colspan='2' width=13% bgcolor='#999999'><div align='center'><strong>Outros</strong></div></td>
							</tr>
							<tr>
							  <td width='65' bgcolor='#CCCCCC'><strong><font size='-1'></font></strong></td>
							  <td width='43' bgcolor='#CCCCCC'><div align='center'><font size='-1'><strong></strong></font></div></td>
							  <td width='112' bgcolor='#CCCCCC'><div align='center'><strong><font size='-1'>Bradesco</font></strong></div></td>
							  <td width='76' bgcolor='#CCCCCC'><div align='center'><strong><font size='-1'>Pamcary</font></strong></div></td>
							  <td width='115' bgcolor='#CCCCCC'><div align='center'><strong><font size='-1'>E-Cargo</font></strong></div></td>
							  <td width='112' bgcolor='#CCCCCC'><div align='center'><strong><font size='-1'>Bradesco</font></strong></div></td>
							  <td width='76' bgcolor='#CCCCCC'><div align='center'><strong><font size='-1'>Pamcary</font></strong></div></td>
							  <td width='115' bgcolor='#CCCCCC'><div align='center'><strong><font size='-1'>E-Cargo</font></strong></div></td>
							  <td width='115' bgcolor='#CCCCCC'><div align='center'><strong><font size='-1'>Bradesco</font></strong></div></td>
							  <td width='76' bgcolor='#CCCCCC'><div align='center'><strong><font size='-1'>Pamcary</font></strong></div></td>
							  <td width='115' bgcolor='#CCCCCC'><div align='center'><strong><font size='-1'>E-Cargo</font></strong></div></td>
							  <td width='112' bgcolor='#CCCCCC'><div align='center'><strong><font size='-1'>Bradesco</font></strong></div></td>
							  <td width='69' bgcolor='#CCCCCC'><div align='center'><strong><font size='-1'>Pamcary</font></strong></div></td>
							</tr>";
					...
					$diversos_bradesco = odbc_result($result, 11);
					$diversos_pamcary  = odbc_result($result, 12);
					$dia_semana 	   = odbc_result($result, 13);
